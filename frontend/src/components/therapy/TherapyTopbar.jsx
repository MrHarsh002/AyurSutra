...
const AdminTopbar = ({ sidebarCollapsed }) => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      navigate("/therapy/search-results", {
    ...
    <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-800 px-4 lg:px-6 py-3 flex items-center justify-between sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative " ref={dropdownRef}>
          ...
          >
            <div className="w-9 h-9 cursor-pointer rounded-full overflow-hidden border-2 border-green-500">
              {user?.photo ? (
...
{open && (
            <div className="absolute right-0 mt-2 w-56 
                bg-white text-gray-700              /* 👈 Light Mode */
                dark:bg-gray-900 dark:text-gray-200 /* 👈 Dark Mode */
