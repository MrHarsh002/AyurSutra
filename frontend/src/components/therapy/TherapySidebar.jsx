...
const AyurSutraSidebar = ({ isCollapsed, onToggleCollapse }) => {
  ...
  const navItems = [
    { to: "/therapy/dashboard", icon: FaTachometerAlt, label: "Dashboard" },
    { to: "/therapy/patients/list", icon: FaUserInjured, label: "Patients" },
    { to: "/therapy/doctors/list", icon: FaUserMd, label: "Doctors" },
    { to: "/therapy/appointments", icon: FaCalendarCheck, label: "Appointments" },
    { to: "/therapy/reports", icon: FaChartLine, label: "Reports" },
